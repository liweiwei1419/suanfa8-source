...
题解地址：[优先队列（Python 代码、Java 代码）](https://leetcode-cn.com/problems/find-median-from-data-stream/solution/you-xian-dui-lie-python-dai-ma-java-dai-ma-by-liwe/)。
...
tags:
  - 优先队列
  - 堆
permalink: algorithms-and-data-structures/0295-find-median-from-data-stream
