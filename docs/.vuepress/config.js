...
(function() {
  ...
  themeConfig: {
    ...
    footer: {
      display: true,
      content: "<a href='https://beian.miit.gov.cn' target='_blank' >闽ICP备2022001209号</a>",
    },
    ...
    comment: {
      ...
      placeholder:
        '留言请不要贴一段代码，让别人找 bug，代码问题请自己调试。填写 E-mail 在收到回复的时候会有邮件通知，有反馈和建议请到右上角「留言反馈」处留言，或者给本 GitHub 提一个 issue。',
    },
